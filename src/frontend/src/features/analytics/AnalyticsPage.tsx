...
export function AnalyticsPage() {
  ...
  const stats = [
    { label: 'Avg Congestion Index', value: '76.2%', change: '+8.4%', up: true, warn: true },
    { label: 'Avg Waiting Time', value: '3.2h', change: '+0.8h vs prev month', up: true, warn: true },
    { label: 'Berth Utilisation', value: '83.7%', change: '+5.2% vs prev month', up: false },
    { label: 'Optimisation Gain', value: '68%', change: 'cumulative improvement', up: false },
  ];

  const charts = [
    { title: 'Historical Congestion Index', subtitle: '30-day trend', data: congestionHistory, color: '#1677C8', secondary: undefined },
    { title: 'Average Waiting Time', subtitle: '30-day trend (hours)', data: waitingTime.map(v => v * 20), color: '#D97706', secondary: undefined },
    { title: 'Berth Utilisation', subtitle: '30-day trend (%)', data: berthUtil, color: '#16A34A', secondary: undefined },
    { title: 'Daily Vessel Arrivals', subtitle: '30-day count', data: arrivals, color: '#145B8C', type: 'bar' },
    { title: 'Predicted vs Actual Congestion', subtitle: '30-day comparison', data: congestionHistory, color: '#1677C8', secondary: congestionHistory.map(v => v * 0.95 + 2) },
    { title: 'Optimisation Impact', subtitle: 'Cumulative wait-time reduction', data: optimizationImpact, color: '#16A34A', secondary: undefined },
  ];
        ...
        {charts.map((chart) => (
          <div key={chart.title} className="hl-card rounded-xl p-5">
            ...
            <div className="flex justify-between mt-3 pt-2 border-t border-[#DCE3E8]">
              ...
              <div className="flex items-center gap-1 text-[10px] text-[#617080]">
